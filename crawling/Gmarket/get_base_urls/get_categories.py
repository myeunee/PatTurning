...
def get_categories():
    ...
    category_collection = db["Gmarket_category_coll"]
    product_collection = db["Gmarket_product_coll"]
            ...
            for subcategory in subcategory_elements:
                ...
                if subcategory_name:
                    ...
                    for subsubcategory in subsubcategory_elements:
                        ...
                        # Gmarket_product_coll에 해당 카테고리 document 없을 경우 빈 document 추가
                        if subsubcategory_id != -1:
                            product_collection.update_one(
                                {"category_id": subsubcategory_id},
                                {
                                    "$setOnInsert": {
                                        "category_id": subsubcategory_id,
                                        "products": [],
    ...
    # 새로운 데이터를 Gmarket_category_coll에 삽입
