from HomePlus_node1 import *
from HomePlusItem import *
from logger import *

TODAY = datetime.datetime.now().strftime("%y%m%d")

LOG_DIR = "homeplus_logs"
LOG_FILENAME = f"homeplus_{TODAY}.log"
OUTPUT_DIR = 'homeplus_data'
OUTPUT_FILENAME = f"homeplus_entire.json"
...
def process_next(generator):
    try: 
        ...
        items = HomePlusItems(category_id, category_name, product_id, price)
        # dic = items.to_dict()
        # print(f"dic: \n{dic}")
...
if __name__ == "__main__":
    ...
    logging.info("STARTEDD CRAWL HOMEPLUS PRODUCT DATA")
